...
//[assembly: Dependency(typeof(TraceLogDemo.Droid.LoggerService))]
        ...
        public void LogTrace(string message)
        {
            ...
            lock (_log)
            {
                try
                {
                    ...
                    {
                        var dt = DateTime.Now;
                        _logfilename = $"elux-{dt.Year:0000}-{dt.Month:00}-{dt.Day:00}-{dt.Hour:00}-{dt.Minute:00}-{dt.Second:00}.txt";
                    }
